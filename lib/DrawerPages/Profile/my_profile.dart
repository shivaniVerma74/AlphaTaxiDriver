                        ...
                        children: [
                          ...
                          Container(
                            child: Padding(
                              padding:
                                  const EdgeInsets.only(left: 30, right: 20),
                              child: Text(
                                getTranslated(context, "Vehicleimage")!,
                                style: TextStyle(color: Colors.black),
                              ),
                            ),
                          ),
                          ...
                          Container(
                            child: Padding(
                              ...
                              const EdgeInsets.only(left: 30, right: 20),
                              child: Text(
                                getTranslated(context, "Adharfontimage")!,
                                style: TextStyle(color: Colors.black),
                              ),
                            ),
                          ),
                          ...
                          Container(
                            child: Padding(
                              ...
                              const EdgeInsets.only(left: 30, right: 20),
                              child: Text(
                                getTranslated(context, "Adharbackimage")!,
                                style: TextStyle(color: Colors.black),
                              ),
                            ),
                          ),
    ...
    if (isNetwork) {
      try {
        ...
        request.fields.addAll({
          ...
          "car_type": cabId,
          "car_model": modelId,
          "user_email": emailCon.text != "" ? emailCon.text.trim().toString() : "",
